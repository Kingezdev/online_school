...
export function LecturerReportsPage({ setPage }) {
  const w = useW();
  const isLg = w >= 1024;
  ...
  const reportTypes = [
    {
      ...
      description: "Overall performance metrics for all courses",
      type: "Comprehensive",
    ...
    {
      id: 4,
      title: "Assignment Grading Summary",
      description: "Grading statistics and submission analysis",
      type: "Assignment",
      lastGenerated: "2026-03-25",
      frequency: "Weekly",
      status: "available"
    },
    {
      ...
      description: "Student participation and engagement data",
      type: "Engagement",
  ...
  const recentReports = [
    {
      name: "March 2026 Course Performance",
      date: "2026-03-24",
      type: "Comprehensive",
      size: "2.4 MB",
      downloads: 12
    ...
    {
      name: "Attendance Report - Week 12",
      date: "2026-03-25",
      type: "Attendance",
      size: "1.1 MB",
      downloads: 8
  ...
  return (
    <div style={{padding:isLg?"24px 32px":16}}>
      <h2 style={{margin:"0 0 16px",fontSize:isLg?20:15,color:"#333",fontWeight:700}}>Reports</h2>
      ...
      <div style={{display:"grid",gridTemplateColumns:isLg?"repeat(4,1fr)":w>=640?"repeat(2,1fr)":"1fr",gap:16,marginBottom:16}}>
        {[
          ...
          {label:"Generated Today",value:"2",icon:"✅",color:C.green},
          {label:"Scheduled",value:"3",icon:"📅",color:C.orange},
          {label:"Total Downloads",value:"35",icon:"⬇️",color:C.purple},
        ].map((stat, index) => (
          <div key={index} style={{
      ...
      <div style={{display:"grid",gridTemplateColumns:isLg?"2fr 1fr":w>=640?"1fr 1fr":"1fr",gap:16}}>
        <SectionCard title="Available Reports" icon="📊" color={C.blue}>
          <div style={{padding:12}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
              <h3 style={{margin:0,fontSize:14,fontWeight:600,color:"#333"}}>Report Types</h3>
              <button style={{
      ...
      <SectionCard title="Report Schedule" icon="📅" color={C.orange}>
        <div style={{padding:12}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
          ...
          <div style={{overflowX:"auto"}}>
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:11}}>
              ...
              <tbody>
                {[
                  {report:"Course Performance",frequency:"Weekly",nextRun:"2026-03-28",status:"Active"},
                  {report:"Attendance Analysis",frequency:"Daily",nextRun:"2026-03-26",status:"Active"},
                  {report:"Student Progress",frequency:"Monthly",nextRun:"2026-04-01",status:"Active"},
                  {report:"Assignment Summary",frequency:"Weekly",nextRun:"2026-03-28",status:"Paused"},
                ].map((schedule, index) => (
                  <tr key={index}>
                    ...
                    <td style={{padding:"8px",borderTop:"1px solid #eee",textAlign:"center"}}>
                      <Badge color={schedule.status === "Active" ? C.green : C.orange}>
                        {schedule.status}
                      </Badge>
                    </td>
                    <td style={{padding:"8px",borderTop:"1px solid #eee",textAlign:"center"}}>
